...
const NEXT_STEPS: Record<ClaimStatus, string[]> = {
  submitted: [
    ...
    'A MyHomebase team member will review within 24 hours.',
    'You will be notified of any status changes.',
  ],
  under_review: [
    'A MyHomebase team member is reviewing the details.',
    "The provider's payout remains in escrow.",
  ...
  denied: [
    ...
    'If you believe this is an error, contact MyHomebase support.',
  ],
  resolved: [
