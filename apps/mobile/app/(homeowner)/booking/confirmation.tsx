...
export default function ConfirmationStep() {
  ...
  return (
    <View testID="booking-step-confirmation" style={{ flex: 1 }}>
      ...
      >
        ...
        <Button testID="booking-confirmation-done" label="View job" size="lg" fullWidth onPress={onDone} />
        <Button testID="booking-confirmation-home" label="Back to home" variant="ghost" fullWidth onPress={onHome} />
      </View>
    </View>
  );
}
