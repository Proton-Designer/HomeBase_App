...
export default function BookingLayout() {
  ...
  // Smooth fade-out on cancel (was a shrink-to-bottom-left scale/translate).
  const dismissStyle = useAnimatedStyle(() => ({ opacity: 1 - dismissT.value }));
  ...
  const onCancel = () => {
    ...
    dismissT.value = withTiming(
      1,
      { duration: DISMISS_DURATION, easing: Easing.out(Easing.ease) },
      (finished) => {
