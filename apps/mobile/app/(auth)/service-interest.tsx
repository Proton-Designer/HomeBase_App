...
import { Alert, Text, ScrollView, Platform } from 'react-native';
...
export default function ServiceInterestScreen() {
  ...
  const onContinue = async () => {
    ...
    if (!pending) {
      ...
      Alert.alert(
        ...
        'Your address details are missing. Please go back and re-enter your address.',
      );
      return;
    }
  ...
  return (
    <AuthScreenShell webContentMaxWidth={460}>
      <ScrollView
