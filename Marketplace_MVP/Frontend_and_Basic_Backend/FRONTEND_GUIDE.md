...
- 3-step illustrated explainer:
  ...
  2. "We match you with one trusted pro" — person with checkmark icon
...
- 4-item feature list:
  1. No lead spam — you get one match, not 5 contractors bidding
...
- "Finding your perfect match..." copy
- Animated illustration: abstract nodes connecting, or a subtle location-pin-pulsing animation
- Duration: 2–3 seconds (artificial delay even if API responds faster — makes the matching feel considered, not random)

**Match result state:**
- "We found your pro" heading with green check
- Full ProviderCard (expanded variant):
