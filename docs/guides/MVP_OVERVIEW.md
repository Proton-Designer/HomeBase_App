...
|---|---|
| Homeowners prefer local, trust-scored providers over national lead spam | Booking request goes to local providers only; homeowner sees trust scores and quotes, then chooses who to hire |
...
| MVP-2 | Local provider marketplace (no pay-per-lead) | Core differentiation from Angi/Thumbtack; requests go to local providers, homeowner chooses, nobody pays until completion |
...
- "Am I getting spammed by 5 different contractors?" → Only local, verified providers can quote; homeowner controls who they hire
...
2. **No pay-per-lead mechanics**: providers are never charged to receive or respond to a request. Homeowner requests are surfaced to qualified local providers only; homeowner sees trust scores and quotes, then chooses who to hire. Nobody pays until the job is verified complete.
